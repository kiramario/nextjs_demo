                    ...
                    if (!done) {
                        ...
                        setHMsg((prevState) => {
                            ...
                            if (last_replay.role == "user") {
                                ...
                                return [...prevState, {role: "ai", msg: last_replay.msg + text}]
    ...
    return (
        <>
            <div className="w-1/2 mx-auto mb-6">
                <input onChange={handleCharIdChange} value={charId} type="text" id="success" className="w-[300px] bg-green-50 border border-green-500 text-green-900  placeholder-green-700 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block p-2.5" placeholder="conversation id" />
            </div>
